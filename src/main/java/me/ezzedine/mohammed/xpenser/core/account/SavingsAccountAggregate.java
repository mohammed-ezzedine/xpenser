...
import me.ezzedine.mohammed.xpenser.core.account.opening.OpenSavingsAccountCommand;
...
public class SavingsAccountAggregate extends AccountAggregate {

    @CommandHandler
    public SavingsAccountAggregate(OpenSavingsAccountCommand command) {
